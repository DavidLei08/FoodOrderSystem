package com.edu.ahtcm.xg.fos.utils.encrypt;
...
public class AESUtil {
    ...
    private static byte[] password = generateKey("3.141592656579396");
    ...
    public static String encryptByToken(String content,String token){
        return encrypt(content,generateKey(token));
    }
    ...
    public static String decryptByToken(String content,String token){
        return decrypt(content, generateKey(token));
    }
